...
# Tue Jun  7 23:27:45 2022
###############################################################################
current_design wrapper_cell
###############################################################################
# Timing Constraints
###############################################################################
...
set_input_delay 80.0000 -clock [get_clocks {clk_master}] -add_delay [get_ports {clkdiv2}]
set_input_delay 80.0000 -clock [get_clocks {clk_master}] -add_delay [get_ports {comp_high_I}]
set_input_delay 80.0000 -clock [get_clocks {clk_master}] -add_delay [get_ports {comp_high_Q}]
...
set_input_delay 80.0000 -clock [get_clocks {clk_master}] -add_delay [get_ports {phi1b_dig_I}]
set_input_delay 80.0000 -clock [get_clocks {clk_master}] -add_delay [get_ports {phi1b_dig_Q}]
...
set_output_delay 80.0000 -clock [get_clocks {clk_master}] -add_delay [get_ports {cclk_I}]
set_output_delay 80.0000 -clock [get_clocks {clk_master}] -add_delay [get_ports {cclk_Q}]
set_output_delay 80.0000 -clock [get_clocks {clk_master}] -add_delay [get_ports {clk_master_out}]
set_output_delay 80.0000 -clock [get_clocks {clk_master}] -add_delay [get_ports {cos_out}]
set_output_delay 80.0000 -clock [get_clocks {clk_master}] -add_delay [get_ports {cos_outb}]
set_output_delay 80.0000 -clock [get_clocks {clk_master}] -add_delay [get_ports {div2out}]
set_output_delay 80.0000 -clock [get_clocks {clk_master}] -add_delay [get_ports {fb1_I}]
set_output_delay 80.0000 -clock [get_clocks {clk_master}] -add_delay [get_ports {fb1_Q}]
set_output_delay 80.0000 -clock [get_clocks {clk_master}] -add_delay [get_ports {fb2_I}]
set_output_delay 80.0000 -clock [get_clocks {clk_master}] -add_delay [get_ports {fb2_Q}]
...
set_output_delay 80.0000 -clock [get_clocks {clk_master}] -add_delay [get_ports {sin_out}]
set_output_delay 80.0000 -clock [get_clocks {clk_master}] -add_delay [get_ports {sin_outb}]
set_output_delay 80.0000 -clock [get_clocks {clk_master}] -add_delay [get_ports {ud_en_out}]
###############################################################################
# Environment
###############################################################################
set_load -pin_load 0.0334 [get_ports {cclk_I}]
set_load -pin_load 0.0334 [get_ports {cclk_Q}]
set_load -pin_load 0.0334 [get_ports {clk_master_out}]
set_load -pin_load 0.0334 [get_ports {cos_out}]
set_load -pin_load 0.0334 [get_ports {cos_outb}]
set_load -pin_load 0.0334 [get_ports {div2out}]
set_load -pin_load 0.0334 [get_ports {fb1_I}]
set_load -pin_load 0.0334 [get_ports {fb1_Q}]
set_load -pin_load 0.0334 [get_ports {fb2_I}]
set_load -pin_load 0.0334 [get_ports {fb2_Q}]
set_load -pin_load 0.0334 [get_ports {rstb_out}]
set_load -pin_load 0.0334 [get_ports {sin_out}]
set_load -pin_load 0.0334 [get_ports {sin_outb}]
...
set_driving_cell -lib_cell sky130_fd_sc_hd__inv_2 -pin {Y} -input_transition_rise 0.0000 -input_transition_fall 0.0000 [get_ports {clkdiv2}]
set_driving_cell -lib_cell sky130_fd_sc_hd__inv_2 -pin {Y} -input_transition_rise 0.0000 -input_transition_fall 0.0000 [get_ports {comp_high_I}]
set_driving_cell -lib_cell sky130_fd_sc_hd__inv_2 -pin {Y} -input_transition_rise 0.0000 -input_transition_fall 0.0000 [get_ports {comp_high_Q}]
set_driving_cell -lib_cell sky130_fd_sc_hd__inv_2 -pin {Y} -input_transition_rise 0.0000 -input_transition_fall 0.0000 [get_ports {phi1b_dig_I}]
set_driving_cell -lib_cell sky130_fd_sc_hd__inv_2 -pin {Y} -input_transition_rise 0.0000 -input_transition_fall 0.0000 [get_ports {phi1b_dig_Q}]
