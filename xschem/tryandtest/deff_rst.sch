...
C {devices/lab_pin.sym} -110 -90 0 0 {name=l5 sig_type=std_logic lab=clk}
C {sky130_stdcells/buf_1.sym} 10 -90 0 0 {name=x9 VGND=GND VNB=GND VPB=VDD VPWR=VDD prefix=sky130_fd_sc_lp__ }
C {sky130_stdcells/buf_1.sym} -70 -90 0 0 {name=x10 VGND=GND VNB=GND VPB=VDD VPWR=VDD prefix=sky130_fd_sc_lp__ }
