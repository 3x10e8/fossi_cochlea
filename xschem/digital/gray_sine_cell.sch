...
C {devices/lab_pin.sym} 240 0 0 0 {name=l27 sig_type=std_logic lab=clk_ext}
...
C {devices/ipin.sym} -580 -200 0 0 {name=p8 lab=clk_ext}
C {devices/ipin.sym} -580 -170 0 0 {name=p9 lab=rstb}
C {sky130_stdcells/or2_0.sym} -400 140 0 0 {name=x26 VGND=vssd1 VNB=vssd1 VPB=vccd1 VPWR=vccd1 prefix=sky130_fd_sc_hd__ }
C {devices/lab_pin.sym} -460 160 0 0 {name=l75 sig_type=std_logic lab=q_jm1}
C {devices/lab_pin.sym} -340 140 2 0 {name=l80 sig_type=std_logic lab=q_msb}
C {devices/lab_pin.sym} -140 -20 0 0 {name=l1 sig_type=std_logic lab=q_msb}
C {devices/lab_pin.sym} -460 120 0 0 {name=l5 sig_type=std_logic lab=q_j}
