...
T {using hd cells for synthesis} 550 150 0 0 0.4 0.4 {}
...
.control
  tran 1n 0.5m
  plot inp inm phi1b/2 polxevent+1 high+2
.endc
.save all
"}
...
C {sky130_stdcells/xor2_1.sym} 1060 60 2 1 {name=x1 VGND=GND VNB=GND VPB=VDD VPWR=VDD prefix=sky130_fd_sc_hd__ }
C {devices/lab_pin.sym} 280 20 3 0 {name=l15 sig_type=std_logic lab=phi1b}
C {sky130_stdcells/dfxtp_1.sym} 730 50 2 1 {name=x11 VGND=gnd VNB=gnd VPB=vdd VPWR=vdd prefix=sky130_fd_sc_hd__ }
C {sky130_stdcells/dfxtp_1.sym} 910 70 2 1 {name=x12 VGND=gnd VNB=gnd VPB=vdd VPWR=vdd prefix=sky130_fd_sc_hd__ }
C {sky130_stdcells/dfxtp_1.sym} 370 10 2 1 {name=x10 VGND=gnd VNB=gnd VPB=vdd VPWR=vdd prefix=sky130_fd_sc_hd__ }
C {sky130_stdcells/dfxtp_1.sym} 550 30 2 1 {name=x13 VGND=gnd VNB=gnd VPB=vdd VPWR=vdd prefix=sky130_fd_sc_hd__ }
C {sky130_stdcells/and2_0.sym} 1180 -30 2 1 {name=x14 VGND=GND VNB=GND VPB=VDD VPWR=VDD prefix=sky130_fd_sc_hd__ }
