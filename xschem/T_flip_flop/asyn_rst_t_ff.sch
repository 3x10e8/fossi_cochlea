...
N -500 -370 -430 -370 { lab=Q_N}
N -430 -370 -420 -370 { lab=Q_N}
...
C {devices/opin.sym} -430 -370 0 0 {name=p5 lab=Q_N}
C {sky130_stdcells/dfrbp_1.sym} -590 -370 0 0 {name=x1 VGND=GND VNB=GND VPB=VDD VPWR=VDD prefix=sky130_fd_sc_lp__ }
