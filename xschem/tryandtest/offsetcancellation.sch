...
C {devices/vsource.sym} 60 -300 0 0 {name=Vinp7 value=sin(0.6,-0.2,5000)}
C {devices/gnd.sym} 60 -270 0 0 {name=l56 lab=GND}
C {devices/lab_pin.sym} 60 -330 0 0 {name=l59 sig_type=std_logic lab=vinm}
C {devices/vsource.sym} 1250 -760 0 0 {name=Vinp8 value=sin(0.6,0.2,5000)}
...
C {devices/vsource.sym} 200 -460 0 0 {name=Vinp10 value=0}
...
C {sky130_fd_pr/nfet3_01v8.sym} 160 -710 0 0 {name=M3
L=0.15
W=0.42
body=GND
nf=1
...
C {sky130_fd_pr/nfet3_01v8.sym} 370 -710 0 1 {name=M14
L=0.15
W=0.42
body=GND
nf=1
