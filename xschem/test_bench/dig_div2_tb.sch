...
+ p_amp3=0
+ p_f3=0}
C {clkgen/dig_div2.sym} 410 0 0 0 {name=x2}
C {devices/lab_pin.sym} 360 -20 0 0 {name=l4 sig_type=std_logic lab=clk_ext}
C {devices/lab_pin.sym} 360 20 0 0 {name=l13 sig_type=std_logic lab=rstb}
C {devices/lab_pin.sym} 410 -60 0 0 {name=l14 sig_type=std_logic lab=vccd1}
C {devices/gnd.sym} 410 60 0 0 {name=l15 lab=GND}
C {devices/lab_pin.sym} 460 -20 2 0 {name=l16 sig_type=std_logic lab=div2out}
C {devices/lab_pin.sym} 460 20 2 0 {name=l17 sig_type=std_logic lab=cclk}
