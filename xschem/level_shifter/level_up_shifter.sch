...
C {devices/iopin.sym} 160 -120 1 0 {name=p3 lab=vssd1
}
C {devices/lab_pin.sym} 550 -110 3 0 {name=l2 sig_type=std_logic lab=vssd1}
C {devices/lab_pin.sym} 470 -180 0 0 {name=l3 sig_type=std_logic lab=in}
C {devices/lab_pin.sym} 520 -340 2 0 {name=l4 sig_type=std_logic lab=vssd1}
C {devices/iopin.sym} 550 -440 3 0 {name=p4 lab=vdda1}
C {devices/lab_pin.sym} 380 -340 0 0 {name=l5 sig_type=std_logic lab=inb}
C {devices/lab_pin.sym} 1000 -110 1 1 {name=l6 sig_type=std_logic lab=vssd1}
C {devices/lab_pin.sym} 1080 -180 0 1 {name=l7 sig_type=std_logic lab=inb}
C {devices/lab_pin.sym} 1030 -340 2 1 {name=l8 sig_type=std_logic lab=vssd1}
...
C {sky130_fd_pr/nfet_01v8.sym} 430 -340 0 0 {name=M4
L=0.15
W=5
nf=1 
mult=1
...
C {sky130_fd_pr/nfet_01v8.sym} 1120 -340 0 1 {name=M5
L=0.15
W=5
nf=1 
mult=1
...
C {sky130_fd_pr/nfet_01v8.sym} 1020 -180 0 1 {name=M6
L=0.15
W=5
nf=1 
mult=1
