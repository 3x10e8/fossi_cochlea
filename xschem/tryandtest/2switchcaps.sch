...
N 150 -0 210 0 { lab=out}
N 210 -0 210 20 { lab=out}
N 210 0 350 -0 { lab=out}
N 0 0 0 20 { lab=c1}
C {devices/gnd.sym} 210 80 0 0 {name=l3 lab=GND}
C {sky130_fd_pr/cap_mim_m3_1.sym} 210 50 0 0 {name=C2 model=cap_mim_m3_1 W=Wcap L=Lcap MF=1 spiceprefix=X}
...
C {devices/iopin.sym} 350 0 0 0 {name=p7 lab=out}
C {devices/gnd.sym} 0 80 0 0 {name=l2 lab=GND}
C {sky130_fd_pr/cap_mim_m3_1.sym} 0 50 0 0 {name=C1 model=cap_mim_m3_1 W=3 L=3 MF=1 spiceprefix=X}
