...
C {devices/vsource.sym} 80 -430 0 0 {name=Vinp2 value="DC 0.4 AM(0.05,0.4,1000,10000,0,0)"}
C {devices/gnd.sym} 80 -280 0 0 {name=l22 lab=GND}
C {devices/lab_pin.sym} 320 -460 0 0 {name=l11 sig_type=std_logic lab=inm}
C {devices/vsource.sym} 320 -430 0 0 {name=Vinp1 value="DC 0.4 AM(-0.05,0.4,1000,10000,0,0)"}
C {devices/gnd.sym} 320 -280 0 0 {name=l14 lab=GND}
...
C {devices/vsource.sym} 80 -370 0 0 {name=Vinp3 value=SFFM(0,0.05,10000,100,100,0,0)}
C {devices/vsource.sym} 320 -370 0 0 {name=VDD4 value=SFFM(0,-0.05,10000,100,100,0,0)}
C {devices/vsource.sym} 320 -310 0 0 {name=VDD2 value="DC 0.4"}
C {devices/vsource.sym} 80 -310 0 0 {name=VDD3 value="DC 0.4"}
