...
C {devices/ipin.sym} -210 90 0 0 {name=p5 lab=vssa}
C {devices/lab_pin.sym} 70 10 2 0 {name=l4 sig_type=std_logic lab=vdda}
C {devices/lab_pin.sym} -70 10 2 0 {name=l5 sig_type=std_logic lab=vdda}
C {devices/lab_pin.sym} -70 -10 0 0 {name=l7 sig_type=std_logic lab=vssa}
