...
C {devices/ipin.sym} -220 120 0 0 {name=p5 lab=vssa}
C {devices/lab_pin.sym} -70 0 0 0 {name=l1 sig_type=std_logic lab=vssa}
C {devices/lab_pin.sym} -70 90 0 0 {name=l3 sig_type=std_logic lab=vdda}
C {devices/lab_pin.sym} -50 10 2 0 {name=l5 sig_type=std_logic lab=vdda}
