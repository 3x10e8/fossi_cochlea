...
export CURRENT_ODB='./results/placement/user_project_wrapper.buffers_removed.odb';
...
export FP_PDN_MACRO_HOOKS=' digital_unison_instance_0 vccd1 vssd1 vccd1 vssd1,  digital_unison_instance_1 vccd1 vssd1 vccd1 vssd1,  digital_unison_instance_2 vccd1 vssd1 vccd1 vssd1,  digital_unison_instance_3 vccd1 vssd1 vccd1 vssd1,  digital_unison_instance_4 vccd1 vssd1 vccd1 vssd1,  digital_unison_instance_5 vccd1 vssd1 vccd1 vssd1,  analog_core_Q_0 vccd1 vssd1 vccd1 vssd1,  analog_core_Q_0 vdda1 vssa1 vdda1 vssd1,  analog_core_I_0 vccd1 vssd1 vccd1 vssd1,  analog_core_I_0 vdda1 vssa1 vdda1 vssd1,  analog_core_Q_1 vccd1 vssd1 vccd1 vssd1,  analog_core_Q_1 vdda1 vssa1 vdda1 vssd1,  analog_core_I_1 vccd1 vssd1 vccd1 vssd1,  analog_core_I_1 vdda1 vssa1 vdda1 vssd1';
...
export PACKAGED_SCRIPT_4='openlane/scripts/openroad/common/set_rc.tcl';
export PACKAGED_SCRIPT_5='openlane/scripts/openroad/common/dpl_cell_pad.tcl';
export PACKAGED_SCRIPT_6='openlane/scripts/openroad/sta.tcl';
export PACKAGED_SCRIPT_7='./tmp/floorplan/3-initial_fp.sdc';
export PACKAGED_SCRIPT_8='./tmp/11-user_project_wrapper.sdc';
...
export SAVE_NETLIST='./tmp/11-user_project_wrapper.nl.v';
export SAVE_ODB='./out.odb';
export SAVE_POWERED_NETLIST='./tmp/11-user_project_wrapper.pnl.v';
export SAVE_SDC='./tmp/11-user_project_wrapper.sdc';
